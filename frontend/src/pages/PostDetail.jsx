...
export default function PostDetail() {
  ...
  // 🧠 prevents double view counting (StrictMode safe)
          ...
          {isAuthor && (
            <div className="flex gap-3 mt-4">
              ...
              <button
                ...
                className="px-4 py-2 text-sm bg-red-500/10 text-red-400 border border-red-500/20 rounded-lg hover:bg-red-500 hover:text-white"
              >
                Delete
              </button>
            </div>
        ...
        {isAuthenticated && (
          <form onSubmit={handleComment} className="mb-8">
            ...
            <textarea
              ...
              rows={3}
              className="w-full p-4 rounded-xl bg-white/5 border border-white/10 focus:ring-2 focus:ring-blue-500"
            />

            <button
              type="submit"
              disabled={submitting || !comment.trim()}
              className="mt-3 px-6 py-2 bg-blue-600 hover:bg-blue-500 rounded-xl font-bold disabled:opacity-50"
            >
